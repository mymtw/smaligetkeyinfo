...
.field public final synthetic $started:Lkotlinx/coroutines/flow/v1;
...
# direct methods
.method public constructor <init>(Lkotlinx/coroutines/flow/v1;Lkotlinx/coroutines/flow/d;Lkotlinx/coroutines/flow/m1;Ljava/lang/Object;Lkotlin/coroutines/c;)V
    .locals 0
    .annotation system Ldalvik/annotation/Signature;
        value = {
            "(",
    ...
    iput-object p1, p0, Lkotlinx/coroutines/flow/FlowKt__ShareKt$launchSharing$1;->$started:Lkotlinx/coroutines/flow/v1;

    iput-object p2, p0, Lkotlinx/coroutines/flow/FlowKt__ShareKt$launchSharing$1;->$upstream:Lkotlinx/coroutines/flow/d;

    iput-object p3, p0, Lkotlinx/coroutines/flow/FlowKt__ShareKt$launchSharing$1;->$shared:Lkotlinx/coroutines/flow/m1;
...
.method public final create(Ljava/lang/Object;Lkotlin/coroutines/c;)Lkotlin/coroutines/c;
    ...
    iget-object v1, p0, Lkotlinx/coroutines/flow/FlowKt__ShareKt$launchSharing$1;->$started:Lkotlinx/coroutines/flow/v1;

    iget-object v2, p0, Lkotlinx/coroutines/flow/FlowKt__ShareKt$launchSharing$1;->$upstream:Lkotlinx/coroutines/flow/d;

    iget-object v3, p0, Lkotlinx/coroutines/flow/FlowKt__ShareKt$launchSharing$1;->$shared:Lkotlinx/coroutines/flow/m1;
...
.method public final invokeSuspend(Ljava/lang/Object;)Ljava/lang/Object;
    ...
    iget-object p1, p0, Lkotlinx/coroutines/flow/FlowKt__ShareKt$launchSharing$1;->$started:Lkotlinx/coroutines/flow/v1;
    ...
    iget-object v1, p0, Lkotlinx/coroutines/flow/FlowKt__ShareKt$launchSharing$1;->$shared:Lkotlinx/coroutines/flow/m1;
    ...
    :cond_4
    sget-object v1, Lkotlinx/coroutines/flow/v1$a;->b:Lkotlinx/coroutines/flow/StartedLazily;

    const/4 v5, 0x0

    if-ne p1, v1, :cond_6

    iget-object p1, p0, Lkotlinx/coroutines/flow/FlowKt__ShareKt$launchSharing$1;->$shared:Lkotlinx/coroutines/flow/m1;

    invoke-interface {p1}, Lkotlinx/coroutines/flow/m1;->d()Lkotlinx/coroutines/flow/internal/q;
    ...
    invoke-static {p1, v1, p0}, Lkotlinx/coroutines/flow/FlowKt__ReduceKt;->b(Lkotlinx/coroutines/flow/d;Lkq/p;Lkotlin/coroutines/c;)Ljava/lang/Object;
    ...
    invoke-interface {v1}, Lkotlinx/coroutines/flow/m1;->d()Lkotlinx/coroutines/flow/internal/q;

    move-result-object v1

    invoke-interface {p1, v1}, Lkotlinx/coroutines/flow/v1;->a(Lkotlinx/coroutines/flow/x1;)Lkotlinx/coroutines/flow/d;

    move-result-object p1

    invoke-static {p1}, Landroidx/compose/foundation/layout/x;->R(Lkotlinx/coroutines/flow/d;)Lkotlinx/coroutines/flow/d;
    ...
    iget-object v4, p0, Lkotlinx/coroutines/flow/FlowKt__ShareKt$launchSharing$1;->$shared:Lkotlinx/coroutines/flow/m1;

    iget-object v6, p0, Lkotlinx/coroutines/flow/FlowKt__ShareKt$launchSharing$1;->$initialValue:Ljava/lang/Object;

    invoke-direct {v1, v3, v4, v6, v5}, Lkotlinx/coroutines/flow/FlowKt__ShareKt$launchSharing$1$2;-><init>(Lkotlinx/coroutines/flow/d;Lkotlinx/coroutines/flow/m1;Ljava/lang/Object;Lkotlin/coroutines/c;)V
