...
.method public constructor <init>(Lor/c;)V
    ...
    iput-object p1, p0, Lio/reactivex/internal/operators/flowable/FlowableOnBackpressureLatest$BackpressureLatestSubscriber;->downstream:Lor/c;
...
.method public checkTerminated(ZZLor/c;Ljava/util/concurrent/atomic/AtomicReference;)Z
    .locals 3
    .annotation system Ldalvik/annotation/Signature;
        value = {
            "(ZZ",
...
.method public drain()V
    ...
    :cond_0
    iget-object v0, p0, Lio/reactivex/internal/operators/flowable/FlowableOnBackpressureLatest$BackpressureLatestSubscriber;->downstream:Lor/c;
    ...
    :goto_1
    invoke-virtual {p0, v9, v12, v0, v2}, Lio/reactivex/internal/operators/flowable/FlowableOnBackpressureLatest$BackpressureLatestSubscriber;->checkTerminated(ZZLor/c;Ljava/util/concurrent/atomic/AtomicReference;)Z
    ...
    :cond_4
    invoke-interface {v0, v11}, Lor/c;->onNext(Ljava/lang/Object;)V
    ...
    :cond_6
    invoke-virtual {p0, v9, v10, v0, v2}, Lio/reactivex/internal/operators/flowable/FlowableOnBackpressureLatest$BackpressureLatestSubscriber;->checkTerminated(ZZLor/c;Ljava/util/concurrent/atomic/AtomicReference;)Z
    ...
    invoke-static {v1, v7, v8}, Lkotlin/jvm/internal/n;->u0(Ljava/util/concurrent/atomic/AtomicLong;J)V
