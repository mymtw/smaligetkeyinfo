...
# static fields
.field public static final BOUNDARY_DISPOSED:Lio/reactivex/internal/operators/flowable/t;
    .annotation system Ldalvik/annotation/Signature;
        value = {
...
.method public static constructor <clinit>()V
    ...
    invoke-direct {v0, v1}, Lio/reactivex/internal/operators/flowable/t;-><init>(Lio/reactivex/internal/operators/flowable/FlowableWindowBoundarySupplier$WindowBoundaryMainSubscriber;)V

    sput-object v0, Lio/reactivex/internal/operators/flowable/FlowableWindowBoundarySupplier$WindowBoundaryMainSubscriber;->BOUNDARY_DISPOSED:Lio/reactivex/internal/operators/flowable/t;
...
.method public constructor <init>(Lor/c;ILjava/util/concurrent/Callable;)V
    .locals 0
    .annotation system Ldalvik/annotation/Signature;
        value = {
            "(",
    ...
    iput-object p1, p0, Lio/reactivex/internal/operators/flowable/FlowableWindowBoundarySupplier$WindowBoundaryMainSubscriber;->downstream:Lor/c;
...
.method public disposeBoundary()V
    ...
    sget-object v1, Lio/reactivex/internal/operators/flowable/FlowableWindowBoundarySupplier$WindowBoundaryMainSubscriber;->BOUNDARY_DISPOSED:Lio/reactivex/internal/operators/flowable/t;
...
.method public drain()V
    ...
    :cond_0
    iget-object v0, p0, Lio/reactivex/internal/operators/flowable/FlowableWindowBoundarySupplier$WindowBoundaryMainSubscriber;->downstream:Lor/c;
    ...
    invoke-static {p0, v7}, Lio/reactivex/processors/UnicastProcessor;->f(Ljava/lang/Runnable;I)Lio/reactivex/processors/UnicastProcessor;
    ...
    invoke-static {v9, v10}, Lio/reactivex/internal/functions/a;->b(Ljava/lang/Object;Ljava/lang/String;)V

    check-cast v9, Lor/b;
    :try_end_0
    .catchall {:try_start_0 .. :try_end_0} :catchall_0

    new-instance v10, Lio/reactivex/internal/operators/flowable/t;

    invoke-direct {v10, p0}, Lio/reactivex/internal/operators/flowable/t;-><init>(Lio/reactivex/internal/operators/flowable/FlowableWindowBoundarySupplier$WindowBoundaryMainSubscriber;)V
    ...
    invoke-interface {v9, v10}, Lor/b;->subscribe(Lor/c;)V

    const-wide/16 v8, 0x1

    add-long/2addr v3, v8

    invoke-interface {v0, v7}, Lor/c;->onNext(Ljava/lang/Object;)V
    ...
    invoke-static {v7}, Lkotlin/reflect/p;->h0(Ljava/lang/Throwable;)V
...
.method public innerNext(Lio/reactivex/internal/operators/flowable/t;)V
    .locals 2
    .annotation system Ldalvik/annotation/Signature;
        value = {
            "(",
