...
# direct methods
.method public constructor <init>(Lzp/a;Ljava/util/Iterator;)V
    .locals 0
    .annotation system Ldalvik/annotation/Signature;
        value = {
            "(",
    ...
    iput-object p1, p0, Lio/reactivex/internal/operators/flowable/FlowableFromIterable$IteratorConditionalSubscription;->downstream:Lzp/a;
...
.method public fastPath()V
    ...
    iget-object v1, p0, Lio/reactivex/internal/operators/flowable/FlowableFromIterable$IteratorConditionalSubscription;->downstream:Lzp/a;
    ...
    :cond_3
    invoke-interface {v1, v2}, Lzp/a;->tryOnNext(Ljava/lang/Object;)Z
...
.method public slowPath(J)V
    ...
    :cond_4
    invoke-interface {v1, v6}, Lzp/a;->tryOnNext(Ljava/lang/Object;)Z
