...
.field public final parent:Lbq/a;
    .annotation system Ldalvik/annotation/Signature;
        value = {
            "Lbq/a<",
            "TT;>;"
...
.method public constructor <init>(Lbq/a;I)V
    ...
    iput-object p1, p0, Lio/reactivex/internal/subscribers/InnerQueuedSubscriber;->parent:Lbq/a;
...
.method public onComplete()V
    ...
    iget-object v0, p0, Lio/reactivex/internal/subscribers/InnerQueuedSubscriber;->parent:Lbq/a;

    invoke-interface {v0, p0}, Lbq/a;->innerComplete(Lio/reactivex/internal/subscribers/InnerQueuedSubscriber;)V
...
.method public onError(Ljava/lang/Throwable;)V
    ...
    invoke-interface {v0, p0, p1}, Lbq/a;->innerError(Lio/reactivex/internal/subscribers/InnerQueuedSubscriber;Ljava/lang/Throwable;)V
...
.method public onNext(Ljava/lang/Object;)V
    ...
    invoke-interface {v0, p0, p1}, Lbq/a;->innerNext(Lio/reactivex/internal/subscribers/InnerQueuedSubscriber;Ljava/lang/Object;)V

    goto :goto_0

    :cond_0
    iget-object p1, p0, Lio/reactivex/internal/subscribers/InnerQueuedSubscriber;->parent:Lbq/a;

    invoke-interface {p1}, Lbq/a;->drain()V
...
.method public onSubscribe(Lorg/reactivestreams/Subscription;)V
    ...
    invoke-interface {v0, v3}, Lzp/e;->requestFusion(I)I
    ...
    iput-object v0, p0, Lio/reactivex/internal/subscribers/InnerQueuedSubscriber;->queue:Lzp/i;

    iput-boolean v4, p0, Lio/reactivex/internal/subscribers/InnerQueuedSubscriber;->done:Z

    iget-object p1, p0, Lio/reactivex/internal/subscribers/InnerQueuedSubscriber;->parent:Lbq/a;

    invoke-interface {p1, p0}, Lbq/a;->innerComplete(Lio/reactivex/internal/subscribers/InnerQueuedSubscriber;)V
    ...
    invoke-direct {v3, v0}, Lio/reactivex/internal/queue/a;-><init>(I)V
    ...
    :goto_1
    iput-object v3, p0, Lio/reactivex/internal/subscribers/InnerQueuedSubscriber;->queue:Lzp/i;
...
.method public queue()Lzp/i;
    ...
    iget-object v0, p0, Lio/reactivex/internal/subscribers/InnerQueuedSubscriber;->queue:Lzp/i;
