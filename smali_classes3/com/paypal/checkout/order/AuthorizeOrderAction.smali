...
.method private final mapError(Lcom/paypal/checkout/order/UpdateOrderStatusResult$Error;)Lcom/paypal/checkout/order/AuthorizeOrderResult$Error;
    ...
    new-instance p1, Lcom/paypal/checkout/order/AuthorizeOrderResult$Error;

    const-string v0, "LSAT upgrade failed while authorizing order."

    invoke-direct {p1, v2, v0, v1, v2}, Lcom/paypal/checkout/order/AuthorizeOrderResult$Error;-><init>(Ljava/lang/String;Ljava/lang/String;ILkotlin/jvm/internal/DefaultConstructorMarker;)V
    ...
    const-string v3, "Authorize order response was not successful. Response status code: "

    invoke-static {v3, p1}, La2/b;->g(Ljava/lang/String;I)Ljava/lang/String;

    move-result-object p1

    invoke-direct {v0, v2, p1, v1, v2}, Lcom/paypal/checkout/order/AuthorizeOrderResult$Error;-><init>(Ljava/lang/String;Ljava/lang/String;ILkotlin/jvm/internal/DefaultConstructorMarker;)V
    ...
    const-string v0, "Authorize was invoked when the order did not have a valid authorize url. This typically happens when authorize is called for a capture order or if authorize was invoked prior to the order being approved."
    ...
    invoke-virtual {p1}, Lcom/paypal/checkout/order/AuthorizeOrderResult$Error;->getMessage()Ljava/lang/String;

    move-result-object v2

    invoke-virtual {p1}, Lcom/paypal/checkout/order/AuthorizeOrderResult$Error;->getReason()Ljava/lang/String;
...
.method public final execute(Lkotlin/coroutines/c;)Ljava/lang/Object;
    ...
    invoke-direct {v1, p0, v2}, Lcom/paypal/checkout/order/AuthorizeOrderAction$execute$2;-><init>(Lcom/paypal/checkout/order/AuthorizeOrderAction;Lkotlin/coroutines/c;)V
