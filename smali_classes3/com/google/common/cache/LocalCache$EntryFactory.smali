...
# virtual methods
.method public copyAccessEntry(Lcom/google/common/cache/h;Lcom/google/common/cache/h;)V
    .locals 2
    .annotation system Ldalvik/annotation/Signature;
        value = {
            "<K:",
    ...
    invoke-interface {v0, p2}, Lcom/google/common/cache/h;->setNextInAccessQueue(Lcom/google/common/cache/h;)V

    invoke-interface {p2, v0}, Lcom/google/common/cache/h;->setPreviousInAccessQueue(Lcom/google/common/cache/h;)V

    invoke-interface {p1}, Lcom/google/common/cache/h;->getNextInAccessQueue()Lcom/google/common/cache/h;

    move-result-object v0

    invoke-interface {p2, v0}, Lcom/google/common/cache/h;->setNextInAccessQueue(Lcom/google/common/cache/h;)V

    invoke-interface {v0, p2}, Lcom/google/common/cache/h;->setPreviousInAccessQueue(Lcom/google/common/cache/h;)V

    sget-object p2, Lcom/google/common/cache/LocalCache$NullEntry;->INSTANCE:Lcom/google/common/cache/LocalCache$NullEntry;

    invoke-interface {p1, p2}, Lcom/google/common/cache/h;->setNextInAccessQueue(Lcom/google/common/cache/h;)V

    invoke-interface {p1, p2}, Lcom/google/common/cache/h;->setPreviousInAccessQueue(Lcom/google/common/cache/h;)V
...
.method public copyWriteEntry(Lcom/google/common/cache/h;Lcom/google/common/cache/h;)V
    .locals 2
    .annotation system Ldalvik/annotation/Signature;
        value = {
            "<K:",
    ...
    invoke-interface {v0, p2}, Lcom/google/common/cache/h;->setNextInWriteQueue(Lcom/google/common/cache/h;)V

    invoke-interface {p2, v0}, Lcom/google/common/cache/h;->setPreviousInWriteQueue(Lcom/google/common/cache/h;)V

    invoke-interface {p1}, Lcom/google/common/cache/h;->getNextInWriteQueue()Lcom/google/common/cache/h;

    move-result-object v0

    invoke-interface {p2, v0}, Lcom/google/common/cache/h;->setNextInWriteQueue(Lcom/google/common/cache/h;)V

    invoke-interface {v0, p2}, Lcom/google/common/cache/h;->setPreviousInWriteQueue(Lcom/google/common/cache/h;)V

    sget-object p2, Lcom/google/common/cache/LocalCache$NullEntry;->INSTANCE:Lcom/google/common/cache/LocalCache$NullEntry;

    invoke-interface {p1, p2}, Lcom/google/common/cache/h;->setNextInWriteQueue(Lcom/google/common/cache/h;)V

    invoke-interface {p1, p2}, Lcom/google/common/cache/h;->setPreviousInWriteQueue(Lcom/google/common/cache/h;)V

    return-void
.end method

.method public abstract newEntry(Lcom/google/common/cache/LocalCache$Segment;Ljava/lang/Object;ILcom/google/common/cache/h;)Lcom/google/common/cache/h;
