...
# instance fields
.field private final wordBoundary:Lcom/google/common/base/a;
...
.method public static constructor <clinit>()V
    ...
    invoke-direct {v1, v2}, Lcom/google/common/base/a$c;-><init>(C)V
    ...
    invoke-direct {v0, v2, v3, v1, v4}, Lcom/google/common/base/CaseFormat$1;-><init>(Ljava/lang/String;ILcom/google/common/base/a;Ljava/lang/String;)V
    ...
    new-instance v2, Lcom/google/common/base/a$c;

    const/16 v4, 0x5f

    invoke-direct {v2, v4}, Lcom/google/common/base/a$c;-><init>(C)V
    ...
    invoke-direct {v1, v5, v6, v2, v7}, Lcom/google/common/base/CaseFormat$2;-><init>(Ljava/lang/String;ILcom/google/common/base/a;Ljava/lang/String;)V
    ...
    invoke-direct {v5}, Lcom/google/common/base/a$b;-><init>()V
    ...
    invoke-direct {v2, v8, v9, v5, v10}, Lcom/google/common/base/CaseFormat$3;-><init>(Ljava/lang/String;ILcom/google/common/base/a;Ljava/lang/String;)V
    ...
    new-instance v8, Lcom/google/common/base/a$b;

    invoke-direct {v8}, Lcom/google/common/base/a$b;-><init>()V

    const-string v11, "UPPER_CAMEL"

    const/4 v12, 0x3

    invoke-direct {v5, v11, v12, v8, v10}, Lcom/google/common/base/CaseFormat$4;-><init>(Ljava/lang/String;ILcom/google/common/base/a;Ljava/lang/String;)V

    sput-object v5, Lcom/google/common/base/CaseFormat;->UPPER_CAMEL:Lcom/google/common/base/CaseFormat;

    new-instance v8, Lcom/google/common/base/CaseFormat$5;

    new-instance v10, Lcom/google/common/base/a$c;

    invoke-direct {v10, v4}, Lcom/google/common/base/a$c;-><init>(C)V

    const-string v4, "UPPER_UNDERSCORE"

    const/4 v11, 0x4

    invoke-direct {v8, v4, v11, v10, v7}, Lcom/google/common/base/CaseFormat$5;-><init>(Ljava/lang/String;ILcom/google/common/base/a;Ljava/lang/String;)V

    sput-object v8, Lcom/google/common/base/CaseFormat;->UPPER_UNDERSCORE:Lcom/google/common/base/CaseFormat;

    const/4 v4, 0x5

    new-array v4, v4, [Lcom/google/common/base/CaseFormat;
    ...
    sput-object v4, Lcom/google/common/base/CaseFormat;->$VALUES:[Lcom/google/common/base/CaseFormat;

    return-void
.end method

.method private constructor <init>(Ljava/lang/String;ILcom/google/common/base/a;Ljava/lang/String;)V
    .locals 0
    .annotation system Ldalvik/annotation/Signature;
        value = {
            "(",
    ...
    .line 3
    iput-object p3, p0, Lcom/google/common/base/CaseFormat;->wordBoundary:Lcom/google/common/base/a;
...
.method public synthetic constructor <init>(Ljava/lang/String;ILcom/google/common/base/a;Ljava/lang/String;Lcom/google/common/base/CaseFormat$1;)V
    .locals 0

    .line 1
    invoke-direct {p0, p1, p2, p3, p4}, Lcom/google/common/base/CaseFormat;-><init>(Ljava/lang/String;ILcom/google/common/base/a;Ljava/lang/String;)V
...
.method public convert(Lcom/google/common/base/CaseFormat;Ljava/lang/String;)Ljava/lang/String;
    ...
    :goto_0
    iget-object v4, p0, Lcom/google/common/base/CaseFormat;->wordBoundary:Lcom/google/common/base/a;

    add-int/lit8 v3, v3, 0x1

    invoke-virtual {v4, v3, p2}, Lcom/google/common/base/a;->b(ILjava/lang/CharSequence;)I
