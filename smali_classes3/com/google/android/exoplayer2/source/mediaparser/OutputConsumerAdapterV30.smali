...
.annotation system Ldalvik/annotation/MemberClasses;
    value = {
        Lcom/google/android/exoplayer2/source/mediaparser/OutputConsumerAdapterV30$a;,
...
.field private extractorOutput:Lph/j;

.field private lastChunkIndex:Lph/c;
...
.field private final scratchDataReaderAdapter:Lcom/google/android/exoplayer2/source/mediaparser/OutputConsumerAdapterV30$a;

.field private seekingDisabled:Z

.field private timestampAdjuster:Lbj/y;
...
.method public constructor <init>(Lcom/google/android/exoplayer2/Format;IZ)V
    ...
    .line 10
    new-instance p1, Lcom/google/android/exoplayer2/source/mediaparser/OutputConsumerAdapterV30$a;

    invoke-direct {p1}, Lcom/google/android/exoplayer2/source/mediaparser/OutputConsumerAdapterV30$a;-><init>()V

    iput-object p1, p0, Lcom/google/android/exoplayer2/source/mediaparser/OutputConsumerAdapterV30;->scratchDataReaderAdapter:Lcom/google/android/exoplayer2/source/mediaparser/OutputConsumerAdapterV30$a;

    .line 11
    new-instance p1, Landroidx/compose/foundation/layout/x;

    invoke-direct {p1}, Landroidx/compose/foundation/layout/x;-><init>()V

    iput-object p1, p0, Lcom/google/android/exoplayer2/source/mediaparser/OutputConsumerAdapterV30;->extractorOutput:Lph/j;
...
.method private static getColorInfo(Landroid/media/MediaFormat;)Lcom/google/android/exoplayer2/video/ColorInfo;
    ...
    invoke-static {p0}, Landroidx/appcompat/widget/d0;->a(Landroid/media/MediaFormat;)I

    move-result v3

    invoke-static {p0}, Landroidx/appcompat/widget/h0;->a(Landroid/media/MediaFormat;)I

    move-result v4

    invoke-static {p0}, Landroidx/core/view/y0;->a(Landroid/media/MediaFormat;)I
...
.method private static getFlag(Landroid/media/MediaFormat;Ljava/lang/String;I)I
    ...
    invoke-static {p0, p1}, Landroidx/compose/ui/platform/u;->a(Landroid/media/MediaFormat;Ljava/lang/String;)I
...
.method private maybeEndTracks()V
    ...
    :cond_2
    iget-object v0, p0, Lcom/google/android/exoplayer2/source/mediaparser/OutputConsumerAdapterV30;->extractorOutput:Lph/j;
...
.method private maybeObtainChunkIndex(Landroid/media/MediaFormat;)Z
    ...
    invoke-direct {p1, v3, v4, v5, v6}, Lph/c;-><init>([I[J[J[J)V

    iput-object p1, p0, Lcom/google/android/exoplayer2/source/mediaparser/OutputConsumerAdapterV30;->lastChunkIndex:Lph/c;

    iget-object v0, p0, Lcom/google/android/exoplayer2/source/mediaparser/OutputConsumerAdapterV30;->extractorOutput:Lph/j;

    invoke-interface {v0, p1}, Lph/j;->l(Lph/t;)V
...
.method private toExoPlayerCryptoData(ILandroid/media/MediaCodec$CryptoInfo;)Lph/v$a;
    .locals 5
    ...
    invoke-static {v3, v2, v1}, Lbj/p;->j(Ljava/lang/String;Ljava/lang/String;Ljava/lang/Throwable;)V

    move v1, v0

    :goto_0
    new-instance v2, Lph/v$a;

    iget v3, p2, Landroid/media/MediaCodec$CryptoInfo;->mode:I

    iget-object v4, p2, Landroid/media/MediaCodec$CryptoInfo;->key:[B

    invoke-direct {v2, v3, v0, v1, v4}, Lph/v$a;-><init>(III[B)V
...
.method private toExoPlayerFormat(Landroid/media/MediaParser$TrackData;)Lcom/google/android/exoplayer2/Format;
    ...
    iput-object p1, v4, Lcom/google/android/exoplayer2/Format$b;->n:Lcom/google/android/exoplayer2/drm/DrmInitData;

    iget-object p1, p0, Lcom/google/android/exoplayer2/source/mediaparser/OutputConsumerAdapterV30;->containerMimeType:Ljava/lang/String;

    iput-object p1, v4, Lcom/google/android/exoplayer2/Format$b;->j:Ljava/lang/String;
    ...
    iput p1, v4, Lcom/google/android/exoplayer2/Format$b;->g:I
    ...
    iput p1, v4, Lcom/google/android/exoplayer2/Format$b;->x:I
    ...
    iput-object p1, v4, Lcom/google/android/exoplayer2/Format$b;->w:Lcom/google/android/exoplayer2/video/ColorInfo;

    iput-object v1, v4, Lcom/google/android/exoplayer2/Format$b;->k:Ljava/lang/String;
    ...
    iput-object p1, v4, Lcom/google/android/exoplayer2/Format$b;->h:Ljava/lang/String;
    ...
    iput p1, v4, Lcom/google/android/exoplayer2/Format$b;->r:F
    ...
    iput p1, v4, Lcom/google/android/exoplayer2/Format$b;->p:I
    ...
    iput p1, v4, Lcom/google/android/exoplayer2/Format$b;->q:I
    ...
    iput-object p1, v4, Lcom/google/android/exoplayer2/Format$b;->m:Ljava/util/List;
    ...
    iput-object p1, v4, Lcom/google/android/exoplayer2/Format$b;->c:Ljava/lang/String;
    ...
    iput p1, v4, Lcom/google/android/exoplayer2/Format$b;->l:I
    ...
    iput p1, v4, Lcom/google/android/exoplayer2/Format$b;->z:I
    ...
    iput p1, v4, Lcom/google/android/exoplayer2/Format$b;->s:I
    ...
    iput p1, v4, Lcom/google/android/exoplayer2/Format$b;->y:I
    ...
    iput p1, v4, Lcom/google/android/exoplayer2/Format$b;->d:I
    ...
    iput p1, v4, Lcom/google/android/exoplayer2/Format$b;->A:I
    ...
    iput p1, v4, Lcom/google/android/exoplayer2/Format$b;->B:I
    ...
    iput p1, v4, Lcom/google/android/exoplayer2/Format$b;->t:F
    ...
    iput-wide v6, v4, Lcom/google/android/exoplayer2/Format$b;->o:J

    iput v2, v4, Lcom/google/android/exoplayer2/Format$b;->C:I

    :goto_0
    iget-object p1, p0, Lcom/google/android/exoplayer2/source/mediaparser/OutputConsumerAdapterV30;->muxedCaptionFormats:Ljava/util/List;
    ...
    iput-object v0, v4, Lcom/google/android/exoplayer2/Format$b;->c:Ljava/lang/String;

    iget v0, p1, Lcom/google/android/exoplayer2/Format;->roleFlags:I

    iput v0, v4, Lcom/google/android/exoplayer2/Format$b;->e:I

    iget v0, p1, Lcom/google/android/exoplayer2/Format;->selectionFlags:I

    iput v0, v4, Lcom/google/android/exoplayer2/Format$b;->d:I

    iget-object v0, p1, Lcom/google/android/exoplayer2/Format;->label:Ljava/lang/String;

    iput-object v0, v4, Lcom/google/android/exoplayer2/Format$b;->b:Ljava/lang/String;

    iget-object p1, p1, Lcom/google/android/exoplayer2/Format;->metadata:Lcom/google/android/exoplayer2/metadata/Metadata;

    iput-object p1, v4, Lcom/google/android/exoplayer2/Format$b;->i:Lcom/google/android/exoplayer2/metadata/Metadata;
...
.method private static toTrackTypeConstant(Ljava/lang/String;)I
    ...
    invoke-static {p0}, Lbj/m;->h(Ljava/lang/String;)I
...
.method public getChunkIndex()Lph/c;
    .locals 1

    iget-object v0, p0, Lcom/google/android/exoplayer2/source/mediaparser/OutputConsumerAdapterV30;->lastChunkIndex:Lph/c;
...
.method public onSampleCompleted(IJIIILandroid/media/MediaCodec$CryptoInfo;)V
    ...
    :cond_0
    iget-object v0, p0, Lcom/google/android/exoplayer2/source/mediaparser/OutputConsumerAdapterV30;->timestampAdjuster:Lbj/y;

    if-eqz v0, :cond_1

    invoke-virtual {v0, p2, p3}, Lbj/y;->a(J)J
    ...
    invoke-direct {p0, p1, p7}, Lcom/google/android/exoplayer2/source/mediaparser/OutputConsumerAdapterV30;->toExoPlayerCryptoData(ILandroid/media/MediaCodec$CryptoInfo;)Lph/v$a;
    ...
    invoke-interface/range {v0 .. v6}, Lph/v;->c(JIIILph/v$a;)V
...
.method public onSampleDataFound(ILandroid/media/MediaParser$InputReader;)V
    ...
    iget-object v0, p0, Lcom/google/android/exoplayer2/source/mediaparser/OutputConsumerAdapterV30;->scratchDataReaderAdapter:Lcom/google/android/exoplayer2/source/mediaparser/OutputConsumerAdapterV30$a;

    iput-object p2, v0, Lcom/google/android/exoplayer2/source/mediaparser/OutputConsumerAdapterV30$a;->a:Landroid/media/MediaParser$InputReader;
    ...
    invoke-interface {v0, p1, v1}, Lph/j;->r(II)Lph/v;
    ...
    :cond_0
    iget-object p1, p0, Lcom/google/android/exoplayer2/source/mediaparser/OutputConsumerAdapterV30;->scratchDataReaderAdapter:Lcom/google/android/exoplayer2/source/mediaparser/OutputConsumerAdapterV30$a;
    ...
    invoke-interface {v0, p1, p2, v1}, Lph/v;->e(Laj/e;IZ)I
...
.method public onSeekMapFound(Landroid/media/MediaParser$SeekMap;)V
    ...
    iget-object v2, p0, Lcom/google/android/exoplayer2/source/mediaparser/OutputConsumerAdapterV30;->extractorOutput:Lph/j;
    ...
    :goto_0
    invoke-direct {p1, v0, v1}, Lph/t$b;-><init>(J)V

    goto :goto_1

    :cond_2
    new-instance v0, Lcom/google/android/exoplayer2/source/mediaparser/OutputConsumerAdapterV30$b;

    invoke-direct {v0, p1}, Lcom/google/android/exoplayer2/source/mediaparser/OutputConsumerAdapterV30$b;-><init>(Landroid/media/MediaParser$SeekMap;)V

    move-object p1, v0

    :goto_1
    invoke-interface {v2, p1}, Lph/j;->l(Lph/t;)V
...
.method public onTrackDataFound(ILandroid/media/MediaParser$TrackData;)V
    ...
    invoke-interface {v2, p1, v1}, Lph/j;->r(II)Lph/v;
...
.method public setExtractorOutput(Lph/j;)V
    .locals 0
...
.method public setTimestampAdjuster(Lbj/y;)V
    .locals 0

    iput-object p1, p0, Lcom/google/android/exoplayer2/source/mediaparser/OutputConsumerAdapterV30;->timestampAdjuster:Lbj/y;
