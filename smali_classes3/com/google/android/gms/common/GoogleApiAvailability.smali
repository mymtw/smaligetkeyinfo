...
.method private static varargs zaa(Lcom/google/android/gms/common/api/HasApiKey;[Lcom/google/android/gms/common/api/HasApiKey;)Lkk/g;
    .locals 4
    ...
    invoke-virtual {p0, v0}, Lcom/google/android/gms/common/api/internal/GoogleApiManager;->zaa(Ljava/lang/Iterable;)Lkk/g;
...
.method public static final synthetic zaa(Ljava/util/Map;)Lkk/g;
    .locals 0
...
.method private final zaa(Landroid/content/Context;ILjava/lang/String;Landroid/app/PendingIntent;)V
    ...
    .line 14
    invoke-direct {v7, p1, v3}, Lu0/m;-><init>(Landroid/content/Context;Ljava/lang/String;)V

    .line 15
    iput-boolean v1, v7, Lu0/m;->r:Z

    const/16 v3, 0x10

    .line 16
    invoke-virtual {v7, v3, v1}, Lu0/m;->g(IZ)V

    .line 17
    invoke-virtual {v7, v0}, Lu0/m;->e(Ljava/lang/CharSequence;)V
    ...
    .line 18
    invoke-virtual {v0, v4}, Lu0/l;->h(Ljava/lang/CharSequence;)V

    invoke-virtual {v7, v0}, Lu0/m;->j(Lu0/q;)V
    ...
    .line 26
    invoke-virtual {v7, v0, v3, p4}, Lu0/m;->a(ILjava/lang/String;Landroid/app/PendingIntent;)V

    goto :goto_0

    .line 27
    :cond_3
    iput-object p4, v7, Lu0/m;->g:Landroid/app/PendingIntent;
    ...
    .line 34
    invoke-virtual {v7, v4}, Lu0/m;->d(Ljava/lang/CharSequence;)V
    ...
    :cond_6
    :goto_1
    iput-object p4, v7, Lu0/m;->z:Ljava/lang/String;

    .line 45
    :cond_7
    invoke-virtual {v7}, Lu0/m;->b()Landroid/app/Notification;
...
.method public static final synthetic zab(Ljava/util/Map;)Lkk/g;
    .locals 0
    .annotation system Ldalvik/annotation/Throws;
        value = {
            Ljava/lang/Exception;
...
# virtual methods
.method public varargs checkApiAvailability(Lcom/google/android/gms/common/api/GoogleApi;[Lcom/google/android/gms/common/api/GoogleApi;)Lkk/g;
    .locals 0
    ...
    .line 3
    invoke-static {p1, p2}, Lcom/google/android/gms/common/GoogleApiAvailability;->zaa(Lcom/google/android/gms/common/api/HasApiKey;[Lcom/google/android/gms/common/api/HasApiKey;)Lkk/g;

    move-result-object p1

    sget-object p2, Lcom/google/android/gms/common/zab;->zaa:Lkk/f;

    .line 4
    invoke-virtual {p1, p2}, Lkk/g;->q(Lkk/f;)Lkk/g;
...
.method public varargs checkApiAvailability(Lcom/google/android/gms/common/api/HasApiKey;[Lcom/google/android/gms/common/api/HasApiKey;)Lkk/g;
    .locals 0
    ...
    sget-object p2, Lcom/google/android/gms/common/zaa;->zaa:Lkk/f;
...
.method public makeGooglePlayServicesAvailable(Landroid/app/Activity;)Lkk/g;
    .locals 3
    .param p1    # Landroid/app/Activity;
        .annotation build Landroidx/annotation/RecentlyNonNull;
        .end annotation
    ...
    invoke-static {v1}, Lkk/j;->e(Ljava/lang/Object;)Lkk/a0;
    ...
    invoke-virtual {p1}, Lcom/google/android/gms/common/api/internal/zabp;->zac()Lkk/g;
