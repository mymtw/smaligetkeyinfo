...
.method public constructor <init>(Lcom/google/firebase/messaging/FirebaseMessaging;J)V
    ...
    iput-object p1, p0, Lbn/z;->d:Lcom/google/firebase/messaging/FirebaseMessaging;

    iput-wide p2, p0, Lbn/z;->b:J

    invoke-virtual {p0}, Lbn/z;->a()Landroid/content/Context;
    ...
    iput-object p1, p0, Lbn/z;->c:Landroid/os/PowerManager$WakeLock;
...
.method public final a()Landroid/content/Context;
    ...
    iget-object v0, p0, Lbn/z;->d:Lcom/google/firebase/messaging/FirebaseMessaging;
...
.method public final c()Z
    ...
    :try_start_0
    iget-object v3, p0, Lbn/z;->d:Lcom/google/firebase/messaging/FirebaseMessaging;
...
.method public final run()V
    ...
    invoke-virtual {v0, v1}, Lbn/x;->c(Landroid/content/Context;)Z

    move-result v0

    if-eqz v0, :cond_0

    iget-object v0, p0, Lbn/z;->c:Landroid/os/PowerManager$WakeLock;
    ...
    :try_start_0
    iget-object v1, p0, Lbn/z;->d:Lcom/google/firebase/messaging/FirebaseMessaging;
    ...
    invoke-virtual {v1, v2}, Lbn/x;->b(Landroid/content/Context;)Z

    move-result v1

    if-eqz v1, :cond_4

    invoke-virtual {p0}, Lbn/z;->b()Z

    move-result v1

    if-nez v1, :cond_4

    new-instance v1, Lbn/z$a;

    invoke-direct {v1, p0}, Lbn/z$a;-><init>(Lbn/z;)V

    invoke-virtual {v1}, Lbn/z$a;->a()V
    :try_end_1
    ...
    invoke-virtual {v1, v2}, Lbn/x;->c(Landroid/content/Context;)Z
    ...
    :cond_7
    iget-object v1, p0, Lbn/z;->c:Landroid/os/PowerManager$WakeLock;
