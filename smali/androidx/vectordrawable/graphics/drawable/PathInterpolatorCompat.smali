...
.method public constructor <init>(Landroid/content/res/Resources;Landroid/content/res/Resources$Theme;Landroid/util/AttributeSet;Lorg/xmlpull/v1/XmlPullParser;)V
    ...
    .line 3
    sget-object v0, Lo2/a;->g:[I

    invoke-static {p1, p2, p3, v0}, Lx0/j;->i(Landroid/content/res/Resources;Landroid/content/res/Resources$Theme;Landroid/util/AttributeSet;[I)Landroid/content/res/TypedArray;
...
.method private parseInterpolatorFromTypeArray(Landroid/content/res/TypedArray;Lorg/xmlpull/v1/XmlPullParser;)V
    ...
    invoke-static {p2, v0}, Lx0/j;->h(Lorg/xmlpull/v1/XmlPullParser;Ljava/lang/String;)Z
    ...
    invoke-static {p1, p2, v0, v1}, Lx0/j;->f(Landroid/content/res/TypedArray;Lorg/xmlpull/v1/XmlPullParser;Ljava/lang/String;I)Ljava/lang/String;
    ...
    invoke-static {p2, v1}, Lx0/j;->h(Lorg/xmlpull/v1/XmlPullParser;Ljava/lang/String;)Z
    ...
    invoke-static {p1, p2, v0, v2, v3}, Lx0/j;->d(Landroid/content/res/TypedArray;Lorg/xmlpull/v1/XmlPullParser;Ljava/lang/String;IF)F

    move-result v0

    const/4 v2, 0x1

    invoke-static {p1, p2, v1, v2, v3}, Lx0/j;->d(Landroid/content/res/TypedArray;Lorg/xmlpull/v1/XmlPullParser;Ljava/lang/String;IF)F
    ...
    invoke-static {p2, v5}, Lx0/j;->h(Lorg/xmlpull/v1/XmlPullParser;Ljava/lang/String;)Z
    ...
    invoke-static {p1, p2, v2, v4, v3}, Lx0/j;->d(Landroid/content/res/TypedArray;Lorg/xmlpull/v1/XmlPullParser;Ljava/lang/String;IF)F

    move-result v2

    const/4 v4, 0x3

    invoke-static {p1, p2, v5, v4, v3}, Lx0/j;->d(Landroid/content/res/TypedArray;Lorg/xmlpull/v1/XmlPullParser;Ljava/lang/String;IF)F
