...
# static fields
.field public static final s:Landroidx/compose/runtime/saveable/h;
...
.field public i:Landroidx/compose/foundation/lazy/layout/h$a;

.field public j:Z

.field public final k:Landroidx/compose/runtime/ParcelableSnapshotMutableState;

.field public final l:Landroidx/compose/foundation/lazy/LazyListState$a;

.field public final m:Landroidx/compose/foundation/lazy/AwaitFirstLayoutModifier;
...
.field public final r:Landroidx/compose/foundation/lazy/layout/h;
...
.method public static constructor <clinit>()V
    ...
    sput-object v0, Landroidx/compose/foundation/lazy/LazyListState;->s:Landroidx/compose/runtime/saveable/h;
...
.method public constructor <init>(II)V
    ...
    invoke-direct {v0, p1, p2}, Landroidx/compose/foundation/lazy/t;-><init>(II)V

    iput-object v0, p0, Landroidx/compose/foundation/lazy/LazyListState;->a:Landroidx/compose/foundation/lazy/t;
    ...
    iput-object p1, p0, Landroidx/compose/foundation/lazy/LazyListState;->b:Landroidx/compose/runtime/ParcelableSnapshotMutableState;
    ...
    .line 5
    iput-object p1, p0, Landroidx/compose/foundation/lazy/LazyListState;->c:Landroidx/compose/foundation/interaction/k;
    ...
    .line 10
    iput-object p2, p0, Landroidx/compose/foundation/lazy/LazyListState;->f:Landroidx/compose/foundation/gestures/DefaultScrollableState;

    const/4 p1, 0x1

    .line 11
    iput-boolean p1, p0, Landroidx/compose/foundation/lazy/LazyListState;->g:Z
    ...
    iput-object p2, p0, Landroidx/compose/foundation/lazy/LazyListState;->k:Landroidx/compose/runtime/ParcelableSnapshotMutableState;

    .line 14
    new-instance p2, Landroidx/compose/foundation/lazy/LazyListState$a;

    invoke-direct {p2, p0}, Landroidx/compose/foundation/lazy/LazyListState$a;-><init>(Landroidx/compose/foundation/lazy/LazyListState;)V

    iput-object p2, p0, Landroidx/compose/foundation/lazy/LazyListState;->l:Landroidx/compose/foundation/lazy/LazyListState$a;
    ...
    iput-object p2, p0, Landroidx/compose/foundation/lazy/LazyListState;->m:Landroidx/compose/foundation/lazy/AwaitFirstLayoutModifier;
    ...
    iput-object p1, p0, Landroidx/compose/foundation/lazy/LazyListState;->n:Landroidx/compose/runtime/ParcelableSnapshotMutableState;
    ...
    .line 17
    invoke-static {p2, p2, p1}, Landroidx/activity/h;->r(III)J
    ...
    iput-object p1, p0, Landroidx/compose/foundation/lazy/LazyListState;->o:Landroidx/compose/runtime/ParcelableSnapshotMutableState;
    ...
    iput-object p1, p0, Landroidx/compose/foundation/lazy/LazyListState;->r:Landroidx/compose/foundation/lazy/layout/h;
...
.method public final a(Landroidx/compose/foundation/MutatePriority;Lkq/p;Lkotlin/coroutines/c;)Ljava/lang/Object;
    ...
    iget-object p3, p0, Landroidx/compose/foundation/lazy/LazyListState;->m:Landroidx/compose/foundation/lazy/AwaitFirstLayoutModifier;
    ...
    :goto_1
    iget-object p3, v2, Landroidx/compose/foundation/lazy/LazyListState;->f:Landroidx/compose/foundation/gestures/DefaultScrollableState;
...
.method public final b()Z
    ...
    iget-object v0, p0, Landroidx/compose/foundation/lazy/LazyListState;->f:Landroidx/compose/foundation/gestures/DefaultScrollableState;
...
.method public final e()I
    ...
    iget-object v0, p0, Landroidx/compose/foundation/lazy/LazyListState;->a:Landroidx/compose/foundation/lazy/t;

    iget-object v0, v0, Landroidx/compose/foundation/lazy/t;->a:Landroidx/compose/runtime/ParcelableSnapshotMutableState;
...
.method public final f()I
    ...
    iget-object v0, v0, Landroidx/compose/foundation/lazy/t;->b:Landroidx/compose/runtime/ParcelableSnapshotMutableState;
...
.method public final g()Landroidx/compose/foundation/lazy/m;
    ...
    iget-object v0, p0, Landroidx/compose/foundation/lazy/LazyListState;->b:Landroidx/compose/runtime/ParcelableSnapshotMutableState;
...
.method public final h(II)V
    ...
    invoke-virtual {v0, p1, p2}, Landroidx/compose/foundation/lazy/t;->a(II)V

    const/4 p1, 0x0

    iput-object p1, v0, Landroidx/compose/foundation/lazy/t;->d:Ljava/lang/Object;

    iget-object p1, p0, Landroidx/compose/foundation/lazy/LazyListState;->n:Landroidx/compose/runtime/ParcelableSnapshotMutableState;

    invoke-interface {p1}, Landroidx/compose/runtime/k1;->getValue()Ljava/lang/Object;

    move-result-object p1

    check-cast p1, Landroidx/compose/foundation/lazy/LazyListItemPlacementAnimator;

    if-eqz p1, :cond_0

    iget-object p2, p1, Landroidx/compose/foundation/lazy/LazyListItemPlacementAnimator;->c:Ljava/util/LinkedHashMap;
    ...
    iput-object p2, p1, Landroidx/compose/foundation/lazy/LazyListItemPlacementAnimator;->d:Ljava/util/Map;

    const/4 p2, -0x1

    iput p2, p1, Landroidx/compose/foundation/lazy/LazyListItemPlacementAnimator;->e:I

    const/4 v0, 0x0

    iput v0, p1, Landroidx/compose/foundation/lazy/LazyListItemPlacementAnimator;->f:I

    iput p2, p1, Landroidx/compose/foundation/lazy/LazyListItemPlacementAnimator;->g:I

    iput v0, p1, Landroidx/compose/foundation/lazy/LazyListItemPlacementAnimator;->h:I

    :cond_0
    iget-object p1, p0, Landroidx/compose/foundation/lazy/LazyListState;->k:Landroidx/compose/runtime/ParcelableSnapshotMutableState;
...
.method public final i(Landroidx/compose/foundation/lazy/l;)V
    .locals 6
    ...
    :try_start_1
    iget-object v3, v0, Landroidx/compose/foundation/lazy/t;->d:Ljava/lang/Object;

    iget-object v4, v0, Landroidx/compose/foundation/lazy/t;->a:Landroidx/compose/runtime/ParcelableSnapshotMutableState;
    ...
    iget v4, v4, Landroidx/compose/foundation/lazy/a;->a:I
    ...
    :cond_2
    :goto_0
    iget-object p1, v0, Landroidx/compose/foundation/lazy/t;->b:Landroidx/compose/runtime/ParcelableSnapshotMutableState;
    ...
    invoke-virtual {v0, v4, p1}, Landroidx/compose/foundation/lazy/t;->a(II)V
