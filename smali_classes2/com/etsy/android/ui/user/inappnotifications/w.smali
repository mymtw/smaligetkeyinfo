.class public final Lcom/etsy/android/ui/user/inappnotifications/w;
...
.method public constructor <init>(Landroid/view/View;Lcom/etsy/android/lib/logger/b;Lkq/l;)V
    ...
    iput-object p3, p0, Lcom/etsy/android/ui/user/inappnotifications/w;->b:Lkq/l;
    ...
    invoke-static {p1}, Landroidx/compose/ui/text/font/d;->g(Landroid/content/Context;)Z

    move-result p2

    if-eqz p2, :cond_0

    const p2, 0x405f5c29    # 3.49f

    goto :goto_0

    :cond_0
    const p2, 0x3fbeb852    # 1.49f
    ...
    iput p2, p0, Lcom/etsy/android/ui/user/inappnotifications/w;->c:I
