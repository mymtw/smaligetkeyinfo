...
.method private getGraphParametersForShareContent()Landroid/os/Bundle;
    ...
    invoke-virtual {v0}, Lcom/facebook/share/model/ShareContent;->getShareHashtag()Lcom/facebook/share/model/ShareHashtag;

    move-result-object v4

    if-eqz v4, :cond_1

    invoke-virtual {v4}, Lcom/facebook/share/model/ShareHashtag;->getHashtag()Ljava/lang/String;

    move-result-object v1

    :cond_1
    invoke-static {v3, v2, v1}, Lhg/i0;->L(Ljava/lang/String;Landroid/os/Bundle;Ljava/lang/String;)V

    invoke-virtual {v0}, Lcom/facebook/share/model/ShareContent;->getContentUrl()Landroid/net/Uri;
    ...
    invoke-static {v1, v2, v0}, Lhg/i0;->L(Ljava/lang/String;Landroid/os/Bundle;Ljava/lang/String;)V
    ...
    :goto_0
    invoke-static {v3, v2, v4}, Lhg/i0;->L(Ljava/lang/String;Landroid/os/Bundle;Ljava/lang/String;)V

    invoke-virtual {v0}, Lcom/facebook/share/model/ShareOpenGraphContent;->getAction()Lcom/facebook/share/model/ShareOpenGraphAction;
    ...
    invoke-static {v4, v2, v3}, Lhg/i0;->L(Ljava/lang/String;Landroid/os/Bundle;Ljava/lang/String;)V

    :try_start_0
    invoke-static {v0}, Lcom/facebook/share/internal/m;->g(Lcom/facebook/share/model/ShareOpenGraphContent;)Lorg/json/JSONObject;

    move-result-object v0

    const/4 v3, 0x0

    invoke-static {v0, v3}, Lcom/facebook/share/internal/m;->f(Lorg/json/JSONObject;Z)Lorg/json/JSONObject;
...
.method private startShare()V
    ...
    sget-object v1, Lhg/l0;->a:Ljava/lang/String;
    ...
    sget-object v0, Lgg/a;->a:Ljava/util/HashMap;
    ...
    :cond_2
    :try_start_0
    invoke-static {v2}, Lgg/a;->c(Ljava/util/Map;)Ljava/lang/String;
    ...
    invoke-virtual {v6}, Lcom/facebook/GraphRequest;->d()Lcom/facebook/GraphRequestAsyncTask;
