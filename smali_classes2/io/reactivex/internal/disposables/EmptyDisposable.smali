...
.method public static complete(Ltp/c;)V
    .locals 1

    .line 5
    sget-object v0, Lio/reactivex/internal/disposables/EmptyDisposable;->INSTANCE:Lio/reactivex/internal/disposables/EmptyDisposable;

    invoke-interface {p0, v0}, Ltp/c;->onSubscribe(Lio/reactivex/disposables/Disposable;)V

    .line 6
    invoke-interface {p0}, Ltp/c;->onComplete()V

    return-void
.end method

.method public static complete(Ltp/k;)V
    .locals 1
    .annotation system Ldalvik/annotation/Signature;
        value = {
            "(",
    ...
    invoke-interface {p0, v0}, Ltp/k;->onSubscribe(Lio/reactivex/disposables/Disposable;)V

    .line 4
    invoke-interface {p0}, Ltp/k;->onComplete()V
...
.method public static error(Ljava/lang/Throwable;Ltp/c;)V
    .locals 1
    ...
    .line 4
    invoke-interface {p1, p0}, Ltp/c;->onError(Ljava/lang/Throwable;)V

    return-void
.end method

.method public static error(Ljava/lang/Throwable;Ltp/k;)V
    .locals 1
    .annotation system Ldalvik/annotation/Signature;
        value = {
            "(",
    ...
    .line 8
    invoke-interface {p1, p0}, Ltp/k;->onError(Ljava/lang/Throwable;)V

    return-void
.end method

.method public static error(Ljava/lang/Throwable;Ltp/u;)V
    .locals 1
    .annotation system Ldalvik/annotation/Signature;
        value = {
            "(",
    ...
    .line 6
    invoke-interface {p1, p0}, Ltp/u;->onError(Ljava/lang/Throwable;)V
