...
.method public constructor <init>(Landroid/view/ViewGroup;Lkq/l;)V
    ...
    iput-object p2, p0, Lme/q;->e:Lkq/l;

    new-instance p1, Ljava/util/LinkedHashMap;

    invoke-direct {p1}, Ljava/util/LinkedHashMap;-><init>()V

    iput-object p1, p0, Lme/q;->f:Ljava/util/LinkedHashMap;

    iget-object p1, p0, Lme/n;->c:Lcom/etsy/android/stylekit/views/CollageRadioGroup;

    new-instance p2, Lme/p;

    invoke-direct {p2, p0}, Lme/p;-><init>(Lme/q;)V
...
.method public final e(Lcom/etsy/android/ui/search/filters/refactor/SearchFiltersUiGroupItem;)V
    ...
    instance-of v0, p1, Lcom/etsy/android/ui/search/filters/refactor/SearchFiltersUiGroupItem$SortBy;
    ...
    iget-object v0, p0, Lme/q;->f:Ljava/util/LinkedHashMap;

    invoke-virtual {v0}, Ljava/util/LinkedHashMap;->clear()V

    check-cast p1, Lcom/etsy/android/ui/search/filters/refactor/SearchFiltersUiGroupItem$SortBy;

    iget-object v0, p1, Lcom/etsy/android/ui/search/filters/refactor/SearchFiltersUiGroupItem$SortBy;->d:Ljava/util/List;
    ...
    iget-object v3, v1, Lcom/etsy/android/ui/search/filters/refactor/SortBySelectItem;->b:Ljava/lang/String;

    invoke-virtual {v0, v3}, Lcom/etsy/android/stylekit/views/CollageRadioButton;->setText(Ljava/lang/String;)V

    iget-boolean v3, v1, Lcom/etsy/android/ui/search/filters/refactor/SortBySelectItem;->c:Z

    invoke-virtual {v0, v3}, Lcom/etsy/android/stylekit/views/CollageRadioButton;->setChecked(Z)V

    iget-object v3, p0, Lme/q;->f:Ljava/util/LinkedHashMap;
